...
parser.add_argument('--n-class', default=10, type=int)
...
parser.add_argument('--test-batch-size', default=1000, type=int, metavar='N',
                    help='test batchsize')
...
parser.add_argument('--ood-data-name', type=str, default='300K_Random') # lsun, 80mTiny, svhn, 300K_Random, imgnet990, places365
parser.add_argument('--ood-rate', default=0, type=float)
