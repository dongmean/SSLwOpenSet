...
def set_parser():
    ...
    parser.add_argument('--root', default='../data/cifar10/', type=str,
                        help='path to data directory')
    parser.add_argument('--dataset', default='cifar10', type=str,
                        choices=['cifar10', 'cifar100', 'imagenet'],
                        help='dataset name')
    parser.add_argument('--ood-dataset', default='svhn', type=str,
                        choices=['svhn', 'lsun', '300Krandom'],
                        help='dataset name')
    parser.add_argument('--ood-data-name', default='300K_Random_dm', type=str,
                        choices=['svhn_dm_extra', '300K_Random_dm'],
                        help='dataset name')
